...
public class EliminarHorarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BT_E.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Eliminar_emp.png"))); // NOI18N
    ...
    private void BT_EActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_EActionPerformed
        if (listaH.isSelectionEmpty()){
            ...
            if (horarios[0] == null) {
                JOptionPane.showMessageDialog(null, "No hay horarios registrados","No hay empleados registrados!",JOptionPane.INFORMATION_MESSAGE);
